...
const EmseforsItem = ({idempresa, name}) => {
    return (
        <div className='col-lg-2 col-md-2'>

            <div class="card card-emsefor-item">

                <div className="d-flex justify-content-center align-content-center">
                    <EmpresasIcon width={80} height={80} id={'icon-empresa'}></EmpresasIcon>
